...
impl RotorCore {
    ...
    pub fn __constructor(env: Env) {
        let relayer = Address::from_string(
            &soroban_sdk::String::from_str(&env, "GC2E5CXISHP3DMHIR674RQL3IQQK3AZEQ2EOOCIZR4B5IYA3KXP3VKKT"),
        );

        let token = Address::from_string(
            &soroban_sdk::String::from_str(&env, "CAS3J7GYLGXMF6TDJBBYYSE3HQ6BBSMLNUQ34T6TZMYMW2EVH34XOWMA"),
        );
